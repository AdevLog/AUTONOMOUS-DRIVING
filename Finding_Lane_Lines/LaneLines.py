...
get_ipython().run_line_magic('time', "process_video('solidWhiteRight.mp4', 'white.mp4')")


# In[21]:


get_ipython().run_line_magic('time', "process_video('solidYellowLeft.mp4', 'yellow.mp4')")


# In[22]:


get_ipython().run_line_magic('time', "process_video('challenge.mp4', 'extra.mp4')")
